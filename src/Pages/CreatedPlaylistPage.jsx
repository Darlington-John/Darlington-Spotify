 ...
 img.onload = () => {
  ...
  return (
    <div className="app-frame md:p-0">
      ...
      <MobileNavbar plalistName={`My Playlist #${playlistId}`} playlistBack=" " />
      <OverLay />
      ...
      <div className="w-screen h-screen fixed  flex items-center justify-center bg-transBlack z-50 top-0 left-0">
        ...
        >
          <div>
            {imgSrcFromCard && (
              <div className="edit-image-container w-60 h-60 xs:w-full relative bg-transparent xs:flex xs:items-center xs:justify-center ">
                {playlistImage ? (
                  <img
                    src={playlistImage}
                    alt="Selected Playlist Image"
                    className="w-60 h-60 xs:w-40 xs:h-auto object-cover"
                  />
                ) : (
                  <img
                    src={imgSrcFromCard}
                    alt="Default Playlist Image"
                    className="w-60 h-60 object-cover xs:w-40 xs:h-40"
                  />
                )}

                <div
                  className=" edit-image flex flex-col gap-3 items-center justify-center   lg:visible"
          ...
          <div className="flex flex-col justify-between items-end xs:items-center xs:flex-row">
            <div>
